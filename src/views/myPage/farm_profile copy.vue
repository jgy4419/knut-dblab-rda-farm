            ...
            <table class="n-table table-row my-info-modify">
                ...
                <tbody>
                    ...
                    <tr class="my-info-img" id="profile-image-area">
                        ...
                        <td>
                            <div>
                                <img class="img" :src="this.user.c_profile_img === '' ? '/member_profile_images/base_image.png' : `/member_profile_images/${this.user.f_profile_img}.png`" alt="프로필 이미지">
                            </div>
                        </td>
                        <td width="65%">
...
export default {
    ...
    methods: {
        ...
        update_consumer_member_f_bank() {
            console.log(typeof  this.f_bank_num);
            console.log(this.f_bank, this.f_bank_name, this.f_bank_num);
            axios.patch('api/farmMemberBank', { 
                f_bank: this.f_bank, 
                f_bank_name: this.f_bank_name, 
                f_bank_num: parseInt(this.f_bank_num),
                farm_id:JSON.parse(localStorage.getItem('user')).farm_id, 
        ...
        update_consumer_member_f_farm_name() {
            axios.patch('api/farmMemberFarmName', {
                farm_id: JSON.parse(localStorage.getItem('user')).farm_id, f_farm_name: this.f_farm_name }, {
                headers: {
                    TOKEN: this.user.token
                }
            }).then(res => {
        ...
        update_consumer_member_f_explanation() {
            axios.patch('api/farmMemberExplanation', { farm_id: JSON.parse(localStorage.getItem('user')).farm_id, f_explanation: this.f_explanation }, {
                headers: {
                    TOKEN: this.user.token
                }
            }).then(res => {
        ...
        update_consumer_member_f_major_crop() {
            axios.patch('api/farmMemberMajorCrop', { 
            farm_id: JSON.parse(localStorage.getItem('user')).farm_id, 
            f_major_crop: this.f_major_crop }, {
                headers: {
                    TOKEN: this.user.token
