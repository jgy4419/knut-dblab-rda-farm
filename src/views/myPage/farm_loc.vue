<template>
    <div>
        ...
        <v-form ref="form" v-model="valid" lazy-validation @submit.prevent="submit_address">
            <input type="text" id="postcode" disabled placeholder="우편번호" v-model="f_zipcode">
            <v-vtn @click="search()">우편번호 찾기</v-vtn><br>
            <!--onclick이 아니라 @click으로 바꿔야한다. -->
            <input type="text" id="roadAddress" disabled placeholder="도로명주소" v-model="r_Addr">
            <input type="text" id="jibunAddress" disabled placeholder="지번주소" v-model="j_Addr">
            <span id="guide" style="color:#000;display:none"></span>
            <input type="text" id="detailAddress"  placeholder="상세주소" v-model="d_Addr">
            <input type="text" id="extraAddress" disabled placeholder="참고항목">
