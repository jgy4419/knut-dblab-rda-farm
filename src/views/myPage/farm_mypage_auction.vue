...
export default {
    ...
    async mounted(){
        ...
        await axios.get(`/mypageAuctionDetails/${userState}/${this.$store.state.login.userInfo.consumer_id}/${0}`)
        .then(res => {
            console.log(res);
